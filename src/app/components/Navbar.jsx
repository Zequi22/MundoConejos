...
export function Navbar() {
  ...
  return (
    <nav className="bg-primary shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm-6 lg-8">
        <div className="flex justify-between items-center h-16">
          <NavLink to="/" className="flex items-center gap-2 text-white group">
            <div className="p-2 bg-white/20 rounded-lg group-hover-white/30 transition-colors">
          ...
          <button
            ...
            className="md p-2 rounded-lg text-white hover-white/20"
          >
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="md bg-white/10 backdrop-blur-lg border-t border-white/20">
